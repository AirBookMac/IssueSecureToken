...
# This scripts creates a secure token to enable FileVault.
...
BannerImage="${4:-"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRgKEFxRXAMU_VCzaaGvHKkckwfjmgGncVjA&usqp=CAU"}"
...
supportTeamName="IT Team"
supportTeamPhone="IT Hotline Number"
supportTeamEmail="IT Mail"
supportTeamWebsite="IT Website"
supportInformation="${8:-"**${supportTeamName}** **Phone:** ${supportTeamPhone} **E-Mail:** ${supportTeamEmail} **Website**: ${supportTeamWebsite}"}"
...
message="## Secure Token\n\nYour Secure Token has not yet been issued.
...
# The body of the message that will be displayed if the secure token is successfully.
SUCCESS_MESSAGE="## Secure Token has been issued successfully.\n\nNow restart your Mac immediately and also enter your Mac password when restarting."
